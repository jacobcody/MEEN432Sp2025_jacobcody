...
set_param('Project1_Option3', 'FastRestart', 'off') %this helps with iterations
load_system("Project1_Option3.slx")
                    ...
                    for w = w_freq
                        for tau = tau_val
                                 ...
                                 try
                                    ...
                                    set_param('Project1_Option3', 'Solver', solver, 'FixedStep', num2str(dT));
                            
                                    tic; %starts timer
                            
                                    sim('Project1_Option3');  
...
fig1 = figure;
hold on;
plot(out.omegaoption3.Data, '-*', 'LineWidth', 1, 'MarkerSize', 5, 'Color', 'b'); 
xlabel('Time (s)');  
ylabel('angular velocity (rad/s)');
